...
def test_generate_recommendations():
    ...
    friction_events = [
        ...
        {"product_id": str(p_id), "reason": "DELIVERY_UNKNOWN", "count": 3},
        {"product_id": str(p_id), "reason": "DELIVERY_TOO_SLOW", "count": 2},
...
def test_aggregate_duplicate_frictions():
    ...
    friction_events = [
        {"product_id": str(p1), "reason": "DELIVERY_UNKNOWN", "count": 2},
        {"product_id": str(p2), "reason": "DELIVERY_UNKNOWN", "count": 5},
        {"product_id": str(p3), "reason": "DELIVERY_UNKNOWN", "count": 3},
